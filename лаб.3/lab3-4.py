...
donut_worry = "Don't worry about apostrophes"
...
''' Чтобы использовать любой строковый метод, поставьте точку в конце строки (или переменной, содержащей строку)
 и введите название метода после точки, например "John".upper()'''
...
''' Специальный символ %d используется в качестве зарезервированного 
места в строке для переменной, имеющей числовое или десятичное значение.'''

name = "John"
print("Hello, PyCharm! My name is %s!" % name)
'''Обратите внимание, что %s расположено внутри строки, а символ % 
расположен после строки'''
