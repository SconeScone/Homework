...
a = input('Шоколадка')  # В переменную a записывается введенное с клавиатура значение
print(a)
...
a = int(input('Введите целое число'))  # Преобразование введенной строки к целочисленному типу данных
b = float(input('Введите вещественое число'))  # Считайте с клавиатуры вещественное число. Используйте функцию float()
print('a + b =', a+b)  # Выведите на экран сумму a и b
