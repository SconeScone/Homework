...
print(not name == "John" or not age == 17)
"""Напишите логическое выражение со значением
"человека зовут John или ему 17" с использованием оператора not"""
...
"""Напишите логическое выражение, проверяющее следующее высказывание:
