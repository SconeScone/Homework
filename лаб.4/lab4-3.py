"""
СЛОВАРЬ похож на список, за исключением того,
что доступ к его значениям осуществляется с помощью ключа вместо индекса. Ключ может быть любой строкой или числом.
...
#  Результат: произошло добавление в словарь нового ключа('Jill') и его значения(456).
